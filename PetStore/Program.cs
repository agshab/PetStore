...
namespace PetStore
{
    internal class program // Create the main function, the entry point of the project
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Press 2 to view catfood, Press 3 to view dogleash, Press 4 to view products in stock, Press 5 to view the total price eand type 'exit' to quit");
